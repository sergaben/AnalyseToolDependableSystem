package uk.ac.kingston.frontend.java.parsers;

import java.util.EnumSet;
import java.util.HashMap;

import uk.ac.kingston.frontend.*;
import uk.ac.kingston.frontend.java.*;
import uk.ac.kingston.intermediate.symtabimpl.*;
import uk.ac.kingston.intermediate.*;
import uk.ac.kingston.intermediate.icodeimpl.*;
import uk.ac.kingston.intermediate.typeimpl.*;

import static uk.ac.kingston.frontend.java.JavaTokenType.*;
import static uk.ac.kingston.frontend.java.JavaErrCode.*;
import static uk.ac.kingston.intermediate.symtabimpl.SymTabKeyImpl.*;
import static uk.ac.kingston.intermediate.symtabimpl.DefinitionImpl.*;
import static uk.ac.kingston.intermediate.icodeimpl.ICodeNodeTypeImpl.*;
import static uk.ac.kingston.intermediate.icodeimpl.ICodeKeyImpl.*;
...
public class ExpressionParser extends StatementParser {
     ...
     */
    public ExpressionParser(JavaParser parent)
    {
        super(parent);
    }

    // Synchronization set for starting an expression.
    static final EnumSet<JavaTokenType> EXPR_START_SET =
        EnumSet.of(PLUS, MINUS, IDENTIFIER, INTEGER, REAL, STRING,
                   JavaTokenType.NOT, LEFT_PAREN);
    ...
    private static final EnumSet<JavaTokenType> REL_OPS =
        EnumSet.of(EQUALS, NOT_EQUALS, LESS_THAN, LESS_EQUALS,
                   GREATER_THAN, GREATER_EQUALS);

    // Map relational operator tokens to node types.
    private static final HashMap<JavaTokenType, ICodeNodeType>
        REL_OPS_MAP = new HashMap<JavaTokenType, ICodeNodeType>();
    static {
    ...
    private static final EnumSet<JavaTokenType> ADD_OPS =
        EnumSet.of(PLUS, MINUS, JavaTokenType.OR);

    // Map additive operator tokens to node types.
    private static final HashMap<JavaTokenType, ICodeNodeTypeImpl>
        ADD_OPS_OPS_MAP = new HashMap<JavaTokenType, ICodeNodeTypeImpl>();
    static {
    ...
    private static final EnumSet<JavaTokenType> MULT_OPS =
        EnumSet.of(STAR, SLASH, DIV, JavaTokenType.MOD, JavaTokenType.AND);

    // Map multiplicative operator tokens to node types.
    private static final HashMap<JavaTokenType, ICodeNodeType>
        MULT_OPS_OPS_MAP = new HashMap<JavaTokenType, ICodeNodeType>();
    static {
